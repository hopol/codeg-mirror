#!/usr/bin/env bash
# 手动镜像 xintaofei/codeg 的 main 分支。
set -euo pipefail

UPSTREAM_URL="https://github.com/xintaofei/codeg.git"
UPSTREAM_WEB_URL="https://github.com/xintaofei/codeg"
UPSTREAM_BRANCH="main"
MIRROR_REPO="https://github.com/hopol/codeg-mirror"
...
git add upstream
git commit -m "chore: mirror codeg-mirror source $SOURCE_VALUE ($SHORT_COMMIT)"
git tag -a "mirror-source-v$SOURCE_VALUE-$SHORT_COMMIT" -m "Mirror codeg-mirror source $SOURCE_VALUE ($SHORT_COMMIT)"
git push origin HEAD
git push origin "mirror-source-v$SOURCE_VALUE-$SHORT_COMMIT"
echo "已同步 codeg-mirror $UPSTREAM_BRANCH：$UPSTREAM_COMMIT"
